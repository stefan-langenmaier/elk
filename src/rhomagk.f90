...
! non-collinear
          ...
          do ir=1,nr,lradstp
            ...
            do itp=1,lmmaxvr
              ...
              magmt(itp,ir,ias,1)=magmt(itp,ir,ias,1)+2.d0*wo*dble(zt1)
              magmt(itp,ir,ias,2)=magmt(itp,ir,ias,2)-2.d0*wo*aimag(zt1)
...
! non-collinear
      do ir=1,ngrtot
        ...
        magir(ir,1)=magir(ir,1)+2.d0*t3*dble(zt1)
        magir(ir,2)=magir(ir,2)-2.d0*t3*aimag(zt1)
